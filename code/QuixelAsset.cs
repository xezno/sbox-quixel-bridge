...
public struct QuixelAsset
{
	...
	[JsonPropertyName( "textureMimeType" )]
	public string TextureMimeType { get; set; }

	[JsonPropertyName( "averageColor" )]
	public string AverageColor { get; set; }

	[JsonPropertyName( "activeLOD" )]
	public string ActiveLOD { get; set; }
	...
	[JsonPropertyName( "packedTextures" )]
	public List<PackedTextures> PackedTextures { get; set; }

	[JsonPropertyName( "meta" )]
	public List<MetaElement> Meta { get; set; }
}
...
public struct PackedTextures : IBaseAsset
{
	...
	[JsonPropertyName( "channelsData" )]
	public ChannelsData ChannelsData { get; set; }
}

public struct ChannelsData
{
	[JsonPropertyName( "Red" )]
	public ChannelInfo Red { get; set; }

	[JsonPropertyName( "Green" )]
	public ChannelInfo Green { get; set; }

	[JsonPropertyName( "Blue" )]
	public ChannelInfo Blue { get; set; }

	[JsonPropertyName( "Alpha" )]
	public ChannelInfo Alpha { get; set; }

	[JsonPropertyName( "Grayscale" )]
	public ChannelInfo Grayscale { get; set; }
}
